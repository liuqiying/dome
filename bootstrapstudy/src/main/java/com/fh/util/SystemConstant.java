...
public class SystemConstant {
    ...
    public static final  int COOKIE_OUT_TIME=7*24*60*60;//记住我 一周
    public static final  int COOKIE_TIME=30*60;//cookie默认有效使时间
    public static final  int LOG_ERROR=0;
    public static final  int LOG_SUCCESS=1;
    public static final  String LOGIN_PAGE="/login.jsp";
    public static final  String NO_PRO_PAGE="/noPro.jsp";
